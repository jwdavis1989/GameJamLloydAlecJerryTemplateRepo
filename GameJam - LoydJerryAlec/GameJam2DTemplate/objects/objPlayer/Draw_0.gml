// Draw fuel if player has one
if(obj_inventory.fuel_cells > 0){
	if(facing = "right"){
		draw_sprite_ext(spr_fuel_cell, 0, x - sprite_get_width(spr_fuel_cell) / 4, 
			y - sprite_get_height(spr_fuel_cell) / 4, 0.8, 0.8, image_angle, c_white, 1);
	}else if(facing = "left"){
		draw_sprite_ext(spr_fuel_cell, 0, x + sprite_get_width(spr_fuel_cell) / 4, 
			y - sprite_get_height(spr_fuel_cell) / 4, 0.8, 0.8, image_angle, c_white, 1);
	}
